...
export default function Registrarse({ userMaster }) {
  ...
  const [fileFotoPerfil, setFileFotoPerfil] = useState("");
  ...
  return (
    <>
      ...
      <CajaContenido>
        ...
        <SeccionFotoPerfil>
          <CajaFotoPerfil>
            <FotoPerfil src={urlLocalFotoPerfil || null} />
            <CajaIcono>
              <Icono
...
const FotoPerfil = styled.img`
  border-radius: 50%;
  border: 4px solid ${Theme.primary.azulProfundo};
  height: 150px;
  width: 150px;
  object-fit: contain;
`;
