...
import { CategoriasLista } from "../DB/DB";
...
export default function ArticulosView({ userMaster, dbArticulos }) {
  ...
  const guardarCambios = async () => {
    ...
    try {
      ...
      console.log(itemEditable.fotos);
  ...
  const generaLinkWA = (codigo) => {
    const apiWhatsApp =
      "https://api.whatsapp.com/send?phone=+18494877649&text=";
    const textoSaludo =
      "Hola equipo de Casteconh, estoy interesado en comprar este producto ";
    const path = "https://casteconh.net/articulos/";
        ...
        <Container>
          ...
          <ContenedorItem>
            ...
            <WrapTop>
              ...
              <CajaDetalles className="titulo">
                {!modoEdicion ? (
                  <TituloItem className="titulo">
                    {itemMaster.descripcion}
                  </TituloItem>
                ) : (
                  <TextAreaText
                    autoComplete="off"
                      ...
                      {!modoEdicion ? (
                        ...
                        >
                          ...
                          {CategoriasLista.map((cat, index) => {
                            return (
                              <Opciones key={index}>{cat.nombre}</Opciones>
                            );
                          })}
                        </MenuDesp>
                      )}
